...
- [x] 生成完整验证 TODO list：补齐 `CGO_ENABLED=0 go test ./...`、全仓 `gopls check`、`./scripts/check-go-gates.sh`、未跟踪 Go 文件检查、官方 Lua 5.3 套件回归和 benchmark 文档回归；详见 `docs/RELEASE_VALIDATION_TODO.md`。
